...
const checks = [
    ...
    atLeast('hardSpeedLoss', metrics.hardSpeedLoss, 30),
    atLeast('cornerInertiaImpactCue', metrics.cornerInertiaImpactCue, 0.7),
    between('cornerInertiaBounceVelocity', metrics.cornerInertiaBounceVelocity, 70, 96),
    between('cornerInertiaDampedVelocity', metrics.cornerInertiaDampedVelocity, 79.1, 79.3),
    between('cornerInertiaDampedHeadingError', metrics.cornerInertiaDampedHeadingError, 0.179, 0.181),
    ...
    between('sustainedHeading', metrics.sustainedHeading, 0.179, 0.181),
    between('sustainedInertia', metrics.sustainedInertia, 79.1, 79.3),
    atLeast('sustainedSpeedLoss', metrics.sustainedSpeedLoss, 30),
