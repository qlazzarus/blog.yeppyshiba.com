...
P0-5 고착 복귀, P0-3 전체/차량별 Records와 목록 탐색, P0-2 전체/차량 PB LAST SPLIT·결과 비교를 1차 구현했다. P0-4 중 checkpoint/finish 시간 보간·focus/숨김 정지도 함께 연결했다. 다음 확인은 세 차량의 실제 코너 고착/탈출 비교 주행과 판정 임계값 튜닝이다. 수동 pause 메뉴·countdown 잔여 프레임 처리·개별 구간 개선 팁은 남아 있으며 P0-4 전체 완료를 뜻하지 않는다.
