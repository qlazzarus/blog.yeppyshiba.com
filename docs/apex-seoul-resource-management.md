...
- [Retro Asset Studio 진행 메모](apex-seoul-retro-asset-studio-progress-notes.md): ComfyUI/차량 실험·검증 기록
- `assets/**/source/**/README.md`, manifest: 개별 원본의 출처·라이선스 기록

새 실험의 수치, 실패 사례, contact sheet 판정은 위 검증 기록에 남기고, 이 문서에는 반복 가능한 원칙만 반영한다.
